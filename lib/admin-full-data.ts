...
export type LeadSource = 'google_maps' | 'messaging' | 'referral' | 'cold_outreach' | 'event' | 'infonegocios' | 'viralist'
...
export const LEADS: Lead[] = [
  ...
  },
  {
    ...
    nextAction: 'Send Messaging follow-up',
    lat: -25.315578,
    lng: -57.5310569,
  ...
  },
  {
    ...
    igHandle: 'unknown',
    hasWebsite: false,
    notes: ['4.8⭐ = MEJOR rating en category make-up. 82 reviews. Messaging directo. Demo sent.'],
